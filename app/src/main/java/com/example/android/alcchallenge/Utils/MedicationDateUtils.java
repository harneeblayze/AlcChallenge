    ...
    public static String getMonth(int monthId){
        ...
        switch (monthId){
            ...
            case 12:
                ...
                break;
            default:
                throw new IllegalArgumentException(monthId + " Is not a valid month id");
        }
        return month;
    }
...
//    }
    ...
    public static long normalDateToMillis(String normalDate) throws ParseException {
        DateFormat dateFormat = DateFormat.getDateTimeInstance();
        long dateInMillis;
        Date date = dateFormat.parse(normalDate);
