...
import com.example.android.alcchallenge.Fragments.DatePickerFragment;
import com.example.android.alcchallenge.Fragments.TimePickerFragment;
...
import com.example.android.alcchallenge.Utils.MedicationDateUtils;
...
public class EditMedActivity extends AppCompatActivity implements EditMedContract.IView{
    ...
    int startDay;
    int startMonthId;
    private EditMedContract.IPresenter mPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       FloatingActionButton fab =
                findViewById(R.id.fab_edit_medication_done);
...
//        String format = "MMM dd yyyy HH:mm";
                ...
                if (!cancel){
                    ...
                    Toast.makeText(EditMedActivity.this, startDate, Toast.LENGTH_SHORT).show();

                    String month =  MedicationDateUtils.getMonth(startMonthId + 1);

                    MedicationsDatabase mdb = MedicationsDatabase.getInstance(getApplicationContext());

                    mAddEditMedicationPresenter = new EditMedPresenter(MedicationsLocalDataSource.getInstance(new AppExecutors(), mdb.medicationsDao()), EditMedActivity.this, "", true);

                    mPresenter.saveMedication(medicationNameEditText.getText().toString(),
                            medicationDescriptionEditText.getText().toString(),
                            timeInterval,
                            startDate, endDate, month, EditMedActivity.this);

                    mPresenter.scheduleMedicationScheduler(EditMedActivity.this, startDate, medicationNameEditText.getText().toString(), timeInterval);
    ...
    private void setUpIntervalSpinner()
    {
        ...
        ArrayAdapter<Integer> intervalAdapter = new ArrayAdapter<Integer>(EditMedActivity.this,
